...
export default function WorkProvider({ children }) {
  const timeLineData = [
    ...
    },
    {
      ...
      skills: "MERN-stack",
      description:
        "Learned fullstack web development skills like MongoDB,Express.js,React.js,Node.js,TS,JS,Saas, Bootstrap",
      type: "study",
    },
    {
      id: "W-2",
    ...
    },
    {
      ...
      skills:
        "Learned Python programming language through Web Sites like Udemy and W3 Schools",
    ...
    },
    {
      ...
      skills:
        "Manual Testing Skills, Java, Selenium WebDriver tool for Automation Testing",
      description:
        "Manually Tested Health Care application and raised more than 500 bugs by performing functional testing.Gained Knowledge on Automation Testing using Selenium Web Driver with Java",
      type: "work",
    },
    {
      id: "W-6",
      ...
      skills:
        "Problem Solving Skills, Analytical Skills, Quick Decision Making Skills, LIstening Skills, Communication Skills",
      description:
        "Solved the problems of many Customers by finding the qick and efficient solution to customers issues through verbal communication and handled more than 1000 customer enquiries about their Order status, returns and refunds",
      type: "work",
    },
    /*  {
        id:'W-7', 
  ...
  return (
    <WorkContext.Provider
      value={{ timeLineData, animLeft, animRight, setAnimLeft, setAnimRight }}
    >
      {children}
    </WorkContext.Provider>
  );
